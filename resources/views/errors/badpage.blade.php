...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(217, 30, 24, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="head-line primary-text-color">
		403
	</div>
	<div class="subheader primary-text-color">
		Access not allowed! <br>
	</div>
    <hr>
    ...
    <p>
      Your access to this routes is not allowed.<br>
      If you think something is correct, report a problem.
    </p>


    </div>
	<div class="buttons-container">
		<a class="border-button" href="{{route('home')}}">Go to home page</a>
	</div>
</div>
